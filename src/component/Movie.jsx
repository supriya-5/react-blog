  ...
  return (
    ...
    <div className='tour'>
     ...
     <Link to="/Movie/Category/article/1">
        <img src={require('./parasite.jpg')} height={200} width={300}/></Link>
        <h3>Parasite</h3>
     ...
     <div>
        <img src={require('./wailing.jpg')}  height={200} width={300}/>
        <h3>The Wailing</h3>
     ...
     <div>
        <img src={require('./tune.jpg')}  height={200} width={300}/>
     ...
     <div>
        <img src={require('./inside.webp')}  height={200} width={300}/>
    ...
    <img src={require('./admovie.png')} width={500} height={800}/>
    </div>
    ...
    <span>
<img src={ require('./Always.jpg')} height={200} width={300} />
<h3>Always</h3>
...
<span>
<img src ={require('./hope.jpg')} height={200} width={300}/>
<h3>Hope</h3>
...
<span>
<img src={require('./witch.jpg')} height={200} width={300}/>
<h3>The Witch</h3>
