...
const Home = () => {
  return (
   ...
   <img  className= "H1"src= {require('./one1.png')} height={400} width={600} alt="one"/></Link>
   <img  className= "H2"src={require('./sk-it.jpg')} height={200} width={300} alt="tech"/>
   <img  className = "H3"src={require('./sk-food.jpg')} height={200} width={300}  alt="food"/>
   </div>
   ...
   <div className='latest'>
    <span>
  <img className= "latest-bts"src={ require('./BTS.webp')} height={200} width={300} alt=""/>
  <h3>BTS</h3>
  ...
  <span>
  <img src ={require('./sk-movie.jpg')} height={200} width={300}/>
  ...
  <span>
  <img src={require('./sk-place.jpg')} height={200} width={300}/>
  <h3>Jinhae</h3>
   ...
   <div className='article'>
    <div>
    <img src={require('./article-food.jpg')} height={200} width={300} />
      ...
      <div>
    <img src={require('./tech.jpg')} height={200} width={300} />
      ...
      <div>
    <img src={require('./swe.jpg')} height={200} width={300} />
   ...
   <div className='post'>
    ...
    <div>
        <img src={require('./blackpink.webp')}/>
        <h3>Blackpink</h3>
   ...
   <div className='stories'>
    <span>
  <img src={ require('./bts_main.webp')} height={200} width={300} />
  <h3>BTS</h3>
...
So watch me bring the fire and set the night alight
  ...
  <span>
  <img src ={require('./Samsung.jpg')} height={200} width={300}/>
  <h3>Samsung</h3>
  ...
  <span>
  <img src={require('./snacks.jpg')} height={200} width={300}/>
  <h3>Ramen</h3>
   ...
   <div className='ad-box'>
    <img src={require('./coke.jpg')} height={400} width={500}/>
   </div>
   </>
  )
}
